...
echo "<td>" . "Olá " . $user_data['nome'] . " escolha um de nossos serviviços: </td>";

echo "<td>
    <a href='serviço-lavagem.php?id_cliente=".$user_data['id_cliente']."'>
        Lavagem&nbsp;
    </a>
    <a href='serviço-pintura.php?id_cliente=".$user_data['id_cliente']."'>
        Pintura&nbsp;
    </a>
    <a href='serviço-manutenção.php?id_cliente=".$user_data['id_cliente']."'>
        Manutenção
    </a>
</td>";
...
<a class='btn btn-sm btn-primary' href='modificar.php?id_cliente=$user_data[id_cliente]' title='Modificar'>
...
<header class="major">
	<h2>Oque posso fazer enquanto espero?</h2>						
</header>
<div class="row">
