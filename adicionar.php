...
<!-- Nossos serviços -->
<h4>Essa aba é destiada para alterar o horário do seu serviço</h4>   <br>

<div class="adc">
<form action="salvar-alteração.php" method="POST"> <p>


Data: <input type="date" name="data_cadastro" id="data_cadastro" value="<?php echo $data_cadastro ?>" > <p>

Hora: <input type="time" name="horario" id="horario" value="<?php echo $horario ?>">   <p> 
