...
if(isset($_POST['submit'])) {
    ...
    $result = mysqli_query($conexao, "INSERT INTO servico (lavagem, pintura, manutencao) 
                VALUES ('$lavagem', NULL, NULL)"); 
    
     $id_cliente = $_GET['id_cliente'];
     header("Location: dados-cliente.php?servico=$lavagem");
    exit();
}
?>
...
<div class="modf">
        <form action="serviço-lavagem.php?id_cliente=<?php echo $_GET['id_cliente']; ?>" method="POST">

            <h4>Escolha o tipo de lavagem para seu veículo:</h4>
            ...
            <label for="detalhada">Detalhada</label>
            ...
            <input type="submit" name="submit" id="submit">
							...
							<article class="box post">
								...
								<header>
									<h3>Oferecemos 3 tipos de lavagem</h3>
								...
								<header>
								<h3> Importância da lavagem </h3>
								</header>
								<p>
									Manter seu veículo limpo preserva a aparência, deixando-o com um aspecto de bem cuidado. Além disso, 
									a lavagem regular ajuda a remover fungos e bactérias, o que contribui para um ambiente mais seguro para seus 
									passageiros. Um veículo limpo também proporciona maior conforto durante a locomoção. Ao longo da vida útil do 
									veículo, se ele recebeu os devidos cuidados de limpeza, isso pode ajudar na valorização do mesmo na hora de 
									vendê-lo.
								</p>					
