...
if (isset($_POST['submit'])) {
    ...
    $result_cliente = mysqli_query($conexao, "INSERT INTO cliente (nome,email,data_cadastro,horario) 
    VALUES ('$nome','$email','$data_cadastro','$horario')");


    $result_veiculo = mysqli_query($conexao, "INSERT INTO veiculo (placa,modelo) 
    VALUES ('$placa','$modelo')");
...
<div class="container"></div>
								...
								<div class="inputForm">
										  ...
										  <br>
										  <div class="">
											<h3> <b></b> FAÇA SEU AGENDAMENTO <h3></h1>
											 
											<div class="container"></div>
											<div class="inputBox">
												<input type="date" name="data_cadastro" id="data_cadastro" class="inputUser" required>
												<label for="data_cadastro" class="labelInput"> </label>
											</div> <br><br>

											<div class="container"></div>
											<div class="inputBox">
												<input type="time" name="horario" id="horario" class="inputUser" required>
												<label for="horario" class="labelInput"> </label>
											</div> <br><br>												
