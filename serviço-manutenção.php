...
if(isset($_POST['submit'])) {
    ...
    $result = mysqli_query($conexao, "INSERT INTO servico (lavagem, pintura, manutencao) 
                VALUES (NULL, NULL, '$manutencao')"); 
    

     $id_cliente = $_GET['id_cliente'];
     header("Location: dados-cliente.php?servico=$manutencao");
    exit();
}
?>
...
Escolha entre os seguintes serviços:<b> balanceamento, troca de óleo, troca de pastilhas de freio ou revisão geral.</b>
<div class="modf">
        <form action="serviço-manutenção.php" method="POST">

            <label for="manutencao">Manutencao:</label>
            <input type="text" name="manutencao" id="manutencao"><br>
...
<article class="box post">
								...
								<header>
								<h2> Oferecemos os seguintes serviços de manutenção: </h2>
								...
								<section>
									<header>
										<h2>Importâcia da manutenção</h2>
									</header>
								É um dos aspectos mais importantes para preservar a vida útil do seu veículo. Um veículo que passa por revisões 
								regulares e recebe os devidos cuidados de manutenção também o valoriza. Além disso, esse cuidado preventivo evita dores de cabeça 
								no futuro. Por outro lado, um veículo que não recebe manutenção adequada pode causar prejuízos financeiros futuros. Portanto, é fundamental 
								realizar a manutenção periódica do veículo para garantir seu bom funcionamento e prolongar sua vida útil.
								</section>
