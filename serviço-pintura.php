...
if(isset($_POST['submit'])) {
    ...
    $result = mysqli_query($conexao, "INSERT INTO servico (lavagem, pintura, manutencao) 
                VALUES (NULL, '$pintura', NULL)"); 
    
   
    $id_cliente = $_GET['id_cliente'];
    header("Location: dados-cliente.php?servico=$pintura");
    exit();
}
?>
...
<!-- Nossos serviços -->
<b>Preencha o campo abaixo indicando a cor e a peça que será pintada, exemplo: rodas/preto</b>
<style>
...
<div class="modf">
        ...
        <form action="serviço-pintura.php" method="POST">

            <label for="pintura">Pintura:</label>
            <input type="text" placeholder="Exemplo:Portas/cinza" name="pintura" id="pintura"><br>
            ...
            <input type="submit" name="submit" id="submit">
							...
							<article class="box post">
								...
								<header>
									<h3>Oferecemos os seguintes serviços de pintura para o seu veículo</h3>
								</header>
								<p>
								...
								<section>
								<header>
									<h3>Importância da pintura</h3>
								</header>
									<p>
									É muito importante manter a pintura do seu veículo em um bom estado, pois isso evita que ele perca o aspecto de 
									novo. Além disso, manter a lataria ou rodas pintadas pode valorizar o veículo. A possibilidade de personalizar 
									algumas partes do veículo através da pintura também pode valorizá-lo na venda ou trazer mais satisfação ao 
									proprietário, já que qualquer modificação automotiva é válida.
								</section>
</section>							
